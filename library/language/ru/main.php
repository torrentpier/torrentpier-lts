...
$lang['COPY_TO_CLIPBOARD'] = 'Копировать в буфер обмена';
...
$lang['AVATAR_PANEL'] = 'Управление аватаркой';
...
$lang['AVATAR_DISABLE'] = 'Опция управления аватаркой отключена за нарушение <a href="%s"><b>правил форума</b></a>';
$lang['UPLOAD_AVATAR_FILE'] = 'Загрузить аватарку';
...
$lang['AVATAR_DIR_SIZE'] = 'Размер директории с аватарками';
...
$lang['USER_ALLOWAVATAR'] = 'Может показывать аватарку';

$lang['ADMIN_AVATAR_EXPLAIN'] = 'Здесь вы можете просмотреть и удалить текущую аватарку пользователя';
