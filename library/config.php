...
$bb_cfg['new_user_reg_restricted'] = false;        // Ограничить регистрацию новых пользователей по времени (24-часовой формат) (часовой пояс используется указанный в настройках форума) (false - выключено) | Пример: array('00', '01', '02', '03'); // часы в которые будет отключена регистрация
