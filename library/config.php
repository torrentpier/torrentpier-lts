...
$bb_cfg['file_id_ext'] = array(
	...
	// то обязательно укажите их в этом массиве тоже. (Шаблон: порядковый номер [порядок не имеет значения] => название расширения).
);
...
$bb_cfg['avatars'] = array(
	'allowed_ext' => array('gif','jpg','jpeg','png','bmp','tiff','tif'), // разрешенные форматы файлов (При добавлении нового расширения, продублируйте в $bb_cfg['file_id_ext'])
