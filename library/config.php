...
// Version info
$bb_cfg['tp_version'] = '2.1.5-2023.10 [Final]';
...
$bb_cfg['new_user_reg_restricted'] = false;        // Ограничить регистрацию новых пользователей по времени (24-часовой формат) (часовой пояс используется указанный в настройках форума) (false - выключено) | Пример: array('06', '07', '08', '09', '10', '11', '12'); // часы в которые будет отключена регистрация
