...
$bb_cfg['new_user_reg_restricted'] = false;        // Ограничить регистрацию новых пользователей по времени. Формат записи: array('from' => '08:00', 'to' => '10:00'); (24-часовой формат) (часовой пояс используется указанный в настройках форума) (false - выключено)
