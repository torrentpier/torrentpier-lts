...
$bb_cfg['new_user_reg_restricted'] = false;        // Ограничить регистрацию новых пользователей по времени (24-часовой формат) (false - выключено) | Пример: array(06, 07, 08, 09, 10, 11, 12); // часы в которые будет отключена регистрация
