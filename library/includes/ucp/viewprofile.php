...
$template->assign_vars(array(
	...
	'BIRTHDAY'             => ($bb_cfg['birthday_enabled'] && $profiledata['user_birthday'] != '1900-01-01') ? $profiledata['user_birthday'] : '',
	'AGE'                  => ($bb_cfg['birthday_enabled'] && $profiledata['user_birthday'] != '1900-01-01') ? birthday_age($profiledata['user_birthday']) : '',
