		...
		case 'stop':
			...
			$this->explain_out .= '
				...
				<tr>
					...
					<th style="height: 22px; cursor: pointer;" align="right" title="'. $lang['COPY_TO_CLIPBOARD'] .'" onclick="$(\'#'. $htid .'\').CopyToClipboard();">'. "$this->db_server.$this->selected_db" .' :: Query #'. ($this->num_queries+1) .'&nbsp;</th>
				</tr>
